...
<style>
    ...
    #package-settings-section .panel-body .tab-content{
        border: 0;
        background: #ffffff;
    }
    #package-settings-section .panel-body .nav-tabs{
        padding-top: 15px;
        padding-left: 15px;
    }
    #file_settings_table td{
    ...
    <form id="wpdm-pf" action="index.php?option=com_downloadmanager&view=package&task=<?php echo $this->task; ?>" method="post">
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="panel panel-default" id="af-section">
...
<?php if(isset($_GET['id'])){ ?>
                <a target="_blank" class="btn btn-lg btn-inverse btn-block" href="<?php echo  str_replace('administrator/', '', JRoute::_(array('option' => 'com_downloadmanager', 'view' => 'package', 'id' => $_GET['id'])));?>"><i class="fa fa-desktop"></i> View Download</a>
                <br/>
                <?php } ?>
                <div class="panel panel-default" id="sef-settings-section">
                ...
                <div class="panel panel-default" id="afs-section">
                ...
                <div class="panel panel-default" id="cat-settings-section">
