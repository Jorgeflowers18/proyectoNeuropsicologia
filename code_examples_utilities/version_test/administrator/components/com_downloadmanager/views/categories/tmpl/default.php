		...
		<?php foreach ( $result as $category ) {
            ...
            <tr valign="top" id="post-<?php echo $category->cid; ?>">
                <td class="media column-media">
                    <a title="Edit" class="post-title"
                       href="index.php?option=com_downloadmanager&view=category&cid=<?php echo $category->cid; ?>"><?php echo $category->name; ?></a>
                </td>
                <td class="parent column-parent"><?php echo $category->package_count; ?></td>
                <td class="actions">
                    <a class="btn btn-primary btn-xs"
                       href="index.php?option=com_downloadmanager&view=category&cid=<?php echo $category->cid; ?>">
                        <i class="fa fa-pencil"></i></a>
                    <a href="#" class="delp btn btn-danger btn-xs" onclick="return false;" data-toggle="popover"
                       data-content="Are You Sure? &nbsp; <a style='margin:0 5px' href='#' class='canceldelete btn btn-default btn-xs pull-right'>No</a> <a href='#' class='submitdelete btn btn-danger btn-xs pull-right' rel='<?php echo $category->cid; ?>'>Yes</a>"
