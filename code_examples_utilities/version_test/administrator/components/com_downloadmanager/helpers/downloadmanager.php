...
class DownloadManagerHelper extends JHelperContent {
	...
	function CustomToolbar() {
        ...
        <div class="dm-toolbar w3eden" id="dm-toolbar">
			...
			<?php foreach ( $this->toolbar_items as $item ) {
				echo '&nbsp;' . $item . '&nbsp;';
			} ?>
            <div class="btn-group pull-right">
                <a type="button" href="http://jdownloadmanager.com/download/joomla-download-manager-pro/" target="_blank" class="btn btn-success">Get the Premium version HERE</a>
            </div>
        </div>
            ...
            <div id="drag-drop-area-<?php echo $id; ?>">
                <div class="drag-drop-inside">
                    ...
                    <p class="drag-drop-buttons">
                        <button id="browse-button-<?php echo $id; ?>" type="button" class="btn btn-primary"><i
                                    class="fa fa-plus"></i> &nbsp; Select Files
                        </button>
                    </p>
                </div>
            </div>
...
//                            };
	...
	static public function getModalButtonObject( $name, $text, $link, $width = 850, $height = 600 ) {
		...
		?>
        <a id="<?php echo $buttonMap->modalname; ?>" class="<?php echo $buttonMap->modalname; ?>"
           title="<?php echo $buttonMap->text; ?>" href="<?php echo $buttonMap->link; ?>"
           rel="<?php echo $buttonMap->options; ?>"><?php echo $buttonMap->text; ?></a>
